const units = {
	...
	dashboard: {
		...
		weaponsByType: 'Theo loại vũ khí',
		weaponType: 'Loại',
		weaponTotal: 'Tổng số',
		weaponInService: 'Đang sử dụng',
		weaponDamaged: 'Hư hỏng',
		weaponLost: 'Mất',
		weaponRetired: 'Thanh lý',
		weaponAssigned: 'Cấp cho quân nhân',
		weaponHeldByUnit: 'Đơn vị quản lý',
		weaponsByUnit: 'Phân bổ theo đơn vị',
		weaponUnit: 'Đơn vị',
		weaponHeldDirectly: '{{name}} (trực tiếp)',
		period: {
			title: 'Biến động theo kỳ',
			subtitle:
				'Số liệu phát sinh trong kỳ đã chọn của đơn vị và các đơn vị trực thuộc.',
			kindLabel: 'Loại kỳ',
			yearLabel: 'Năm',
			periodLabel: 'Kỳ',
			month: 'Tháng',
			...
			loadFailed: 'Không tải được số liệu theo kỳ.',
			weaponActivity: 'Hoạt động vũ khí/trang bị',
			assigned: 'Cấp cho quân nhân',
			unassigned: 'Trả về đơn vị',
			transferred: 'Điều chuyển',
			damaged: 'Hư hỏng',
			lost: 'Mất',
			retired: 'Thanh lý',
			troopMovement: 'Biến động quân số',
			joined: 'Quân nhân mới (tạo hồ sơ)',
			transferredIn: 'Chuyển đến',
			transferredOut: 'Chuyển đi',
			promoted: 'Thăng quân hàm',
			discharged: 'Xuất ngũ',
			cpvAdmitted: 'Kết nạp Đảng',
			supplyMovement: 'Vật tư chuyển giao',
			supplyNote:
				'Chỉ tính vật tư chuyển giao đã được duyệt giữa các đơn vị, không phản ánh mức tiêu hao.',
			received: 'Nhận',
			sent: 'Chuyển đi',
			noSupplyMovement: 'Không có vật tư chuyển giao trong kỳ này.'
		}
	},
	management: {
